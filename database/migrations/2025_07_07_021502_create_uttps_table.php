...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('uttps', function (Blueprint $table) {
            $table->id();
            $table->string('kode_uttp', 20)->unique(); // Auto-generated unique code
            
            // Data Pemilik
            $table->string('nama_pemilik', 100);
            $table->string('nik_pemilik', 20)->nullable();
            $table->string('telepon_pemilik', 15)->nullable();
            ...
            $table->string('detail_lokasi', 100)->nullable(); // Nama pasar atau detail lokasi
            ...
            // Dokumentasi
            $table->json('foto_uttp')->nullable(); // Array path foto
            ...
            $table->index(['nama_pemilik', 'is_active']);
