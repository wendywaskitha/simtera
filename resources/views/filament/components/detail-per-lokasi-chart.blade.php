            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-center font-medium text-gray-900 dark:text-gray-100">Sah</th>
                        <th class="px-4 py-2 text-center font-medium text-gray-900 dark:text-gray-100">Batal</th>
