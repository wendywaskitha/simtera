        ...
        @foreach($data as $item)
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600 dark:text-gray-400">Lulus:</span>
                        <span class="font-medium text-green-600">{{ number_format($item['lulus']) }}</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600 dark:text-gray-400">Tidak Lulus:</span>
                        <span class="font-medium text-red-600">{{ number_format($item['total'] - $item['lulus']) }}</span>
                    </div>
                </div>
